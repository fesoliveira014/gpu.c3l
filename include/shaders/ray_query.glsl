// gpu.c3l opt-in ray-query helpers.
//
// AccelerationStructureIndex values encode the zero-based binding-5 slot plus
// one. GPU-authored instance fields must already fit their documented 24-bit
// and 8-bit widths. The shader-binding-table record offset is always zero.

#ifndef GPU_RAY_QUERY_GLSL
#define GPU_RAY_QUERY_GLSL
