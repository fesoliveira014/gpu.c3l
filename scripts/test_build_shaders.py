...
from scripts import build_shaders


GENERATED = """// Generated by gpu_shaders from the 'probe' ABI schema - do not edit.
module gpu;
...
class BuildShadersTest(unittest.TestCase):
    ...
    def test_splits_public_declarations_from_private_metadata(self) -> None:
        public, private = build_shaders.split_gpu_c3(GENERATED)
    ...
    def test_marked_block_detects_and_repairs_drift(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            path.write_text(
                "module gpu;\n\n"
                f"{build_shaders.PUBLIC_ABI_START}\nold\n"
                f"{build_shaders.PUBLIC_ABI_END}\n",
                encoding="utf-8",
            )

            with contextlib.redirect_stderr(io.StringIO()):
                self.assertFalse(build_shaders.sync_marked_block(
                    path,
                    build_shaders.PUBLIC_ABI_START,
                    build_shaders.PUBLIC_ABI_END,
                    "new\n",
                    True,
                ))
            self.assertTrue(build_shaders.sync_marked_block(
                path,
                build_shaders.PUBLIC_ABI_START,
                build_shaders.PUBLIC_ABI_END,
                "new\n",
